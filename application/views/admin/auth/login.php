...
<head>
    ...
    <title><?php echo isset($title) ? html_escape($title) : 'Admin Login'; ?> - DDI Checker</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="auth-card">
    <div class="text-center mb-4">
        <div class="d-inline-flex align-items-center justify-content-center p-3 rounded-circle mb-2" style="background-color: #ccfbf1;">
            <i class="bi bi-shield-lock-fill fs-2" style="color: #0d9488;"></i>
        </div>
        <div>
            <span class="admin-tag mb-2">SYSTEM ADMINISTRATION</span>
        </div>
        <h3 class="fw-bold text-dark mb-1">Admin Access</h3>
        <p class="text-muted small">Sign in to manage clinical data & drugs</p>
    </div>
    ...
    <?php echo form_open('admin/login', ['class' => 'needs-validation']); ?>
        <div class="mb-3">
            <label for="email" class="form-label fw-semibold text-secondary small mb-1">Admin Email</label>
            <div class="input-group">
                <span class="input-group-text bg-light border-end-0 text-muted"><i class="bi bi-envelope"></i></span>
                <input type="email" name="email" id="email" class="form-control bg-light border-start-0 <?php echo form_error('email') ? 'is-invalid' : ''; ?>" placeholder="admin@domain.com" value="<?php echo set_value('email'); ?>" required autocomplete="email">
            </div>
