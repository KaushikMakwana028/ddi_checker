...
<div class="form-page-container">
    ...
    <div class="page-header mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h2 class="page-title">Register New Medicine</h2>
                <p class="page-subtitle">Add a chemical entity or pharmaceutical product to the clinical database.</p>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 rounded-4 shadow-sm form-card">
        <div class="card-header bg-white border-bottom py-3.5 px-4 d-flex align-items-center gap-3">
            ...
            <div>
                <h5 class="mb-0 fw-bold text-dark">Drug Profile &amp; Inventory Details</h5>
                <small class="text-muted">Fields marked with <span class="text-danger">*</span> are mandatory.</small>
            </div>
        </div>

        <div class="card-body p-4 p-md-5">
            <?php echo form_open('admin/drug-entry/add', ['id' => 'addDrugForm', 'autocomplete' => 'off']); ?>
                <div class="row g-4">
                    <!-- Drug Name -->
                    <div class="col-md-6">
                        <div class="form-field">
                            ...
                            <div class="input-icon">
                                <i class="bi bi-capsule"></i>
                                <input type="text" id="drug_name" name="drug_name" value="<?php echo set_value('drug_name'); ?>" required placeholder="e.g. Ibuprofen, Warfarin, Metformin">
                            </div>
                            <span class="field-hint">Primary pharmacological or active chemical name.</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-field">
                            ...
                            <div class="input-icon">
                                <i class="bi bi-tag"></i>
                                <input type="text" id="category" name="category" value="<?php echo set_value('category'); ?>" placeholder="e.g. NSAID, Anticoagulant, Biguanide">
                            </div>
                            <span class="field-hint">Classification based on clinical action or target system.</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-field">
                            <label for="quantity">Initial Stock Quantity <span class="req">*</span></label>
                            <div class="input-icon">
                                <i class="bi bi-123"></i>
                                <input type="number" id="quantity" name="quantity" min="0" value="<?php echo set_value('quantity', '0'); ?>" required placeholder="e.g. 100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-field">
                            ...
                            <select id="unit" name="unit">
                                ...
                                <option value="Tablets" <?php echo set_select('unit', 'Tablets'); ?>>Tablets</option>
                                <option value="Capsules" <?php echo set_select('unit', 'Capsules'); ?>>Capsules</option>
                                <option value="ml" <?php echo set_select('unit', 'ml'); ?>>ml</option>
                                <option value="Vials" <?php echo set_select('unit', 'Vials'); ?>>Vials</option>
                                <option value="Sachets" <?php echo set_select('unit', 'Sachets'); ?>>Sachets</option>
                            </select>
                    ...
                    <div class="col-12">
                        <div class="form-field">
                            ...
                            <textarea id="synonyms" name="synonyms" rows="3" placeholder="e.g. Advil, Motrin, Nurofen, Brufen"><?php echo set_value('synonyms'); ?></textarea>
                            <span class="field-hint">Separate multiple trade names, synonyms, or salt variants with a comma.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-actions mt-5 pt-3 border-top d-flex align-items-center justify-content-between flex-wrap gap-3">
                    ...
                    <button type="submit" class="btn-page-primary">
                        <i class="bi bi-check-lg"></i> <span>Save &amp; Register Medicine</span>
                    </button>
                </div>
            <?php echo form_close(); ?>
        </div>
